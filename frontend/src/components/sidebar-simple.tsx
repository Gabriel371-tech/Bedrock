    ...
    <aside className="w-80 min-w-[20rem] z-20 flex h-[calc(100vh-2rem)] flex-col gap-4 rounded-lg bg-{#18396F} text-white p-4">
      ...
      <nav className="flex-1 overflow-y-auto px-1">
        <ul className="flex flex-col gap-1">
          ...
          <li>
            <Link to="/disciplinas" className="flex items-center gap-3 rounded-md px-3 py-2 hover:bg-white hover:text-black">
              <img
                src={Disciplinas}
          ...
          <li>
            <Link to="/chat" className="flex items-center gap-3 rounded-md px-3 py-2 hover:bg-white hover:text-black">
              <img
                src={Chat}
                alt="Ícone de Chat"
                className="h-5 w-5 object-contain"
          ...
          <li>
            <Link to="/biblioteca" className="flex items-center gap-3 rounded-md px-3 py-2 hover:bg-white hover:text-black">
              <img
                src={Biblioteca}
          ...
          <li>
            <Link to="/estatistica" className="flex items-center gap-3 rounded-md px-3 py-2 hover:bg-white hover:text-black">
              <img
                src={Estatica}
          ...
          <li>
            <Link to="/settings" className="flex items-center gap-3 rounded-md px-3 py-2 hover:bg-white hover:text-black">
